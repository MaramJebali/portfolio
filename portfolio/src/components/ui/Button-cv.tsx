    ...
    if (status === 'done') {
      return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="sparkle">
          <path className="path" strokeLinejoin="round" strokeLinecap="round" stroke="black" fill="black" d="M4.5 12.75L9.75 18L19.5 6.75" />
        </svg>
      );
    }
    return (
  ...
  return (
    <StyledWrapper className={className}>
      ...
      >
        ...
        {getIcon()}
        <span className="text_button">{getText()}</span>
      </button>
    </StyledWrapper>
  );
}
...
const StyledWrapper = styled.div`
  ...
  .button .dots_border::before {
    ...
    width: 100%;
    height: 1.5rem; /* 👇 ADJUSTED - Smaller border height */
  ...
  .button.done {
    --active: 1;
    animation: pulse-done 1.2s ease-in-out 2;
  }
